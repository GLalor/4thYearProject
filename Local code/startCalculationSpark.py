...
findspark.init("C:\spark-2.2.1-bin-hadoop2.7") # set to install location of spark and hadoop as prebuilt
...
def main():
	...
	option_prices_data.write.save('E:\ProjectDB6', format='json', mode='append') # set DB location

...
sparkSession._jsc.hadoopConfiguration().set("fs.azure",
                                            "org.apache.hadoop.fs.azure.NativeAzureFileSystem")
sparkSession._jsc.hadoopConfiguration().set(
...
baseDir = "wasb[s]://optiondata-2018-04-10t08-21-24-836z@optiondatastorage.blob.core.windows.net/GPUData/"
